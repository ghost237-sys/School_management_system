...
urlpatterns = [
    ...
    path('api/edit/', views.timetable_edit_api, name='timetable_edit_api'),
    ...
    path('api/notifications/<int:notification_id>/read/', views.mark_notification_as_read_api, name='mark_notification_as_read_api'),
]
